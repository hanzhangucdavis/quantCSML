...
for i in range(8):
    ...
    for j in range(10):
        ...
        model.fit(quantTime, support, epochs=25, verbose=1)
...
l3=plt.plot(xaxis,det,label='det')
plt.legend()
plt.show()
